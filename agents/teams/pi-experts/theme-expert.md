...
- Theme locations: ~/agent/themes/, themes/
...
Then read /tmp/pi-theme-docs.md to have the freshest reference. Also search the local codebase (themes/) for existing theme examples.
